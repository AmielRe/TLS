...
public class CustomRoomSpinnerAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.custom_room_spinner_row, null);
        ...
        roomCapacity.setText(String.format("%d/%d", rooms[i].currentCapacity, rooms[i].maxCapacity));
        roomGenderType.setText(String.format("%s (%s): ", CommonUtils.intToRoomType(rooms[i].roomType), CommonUtils.intToGender(rooms[i].roomGender)));
        return view;
    }
}
